...
def build_czech_one_pager(output_path):
    ...
    • <b>Klíčové technologické inovace:</b> Autonomní detekce impaktního kráteru po sondě NASA DART v C, deterministická vlnková komprese šetřící 82 % downlinku, in-situ triangulace 3D modelu tělesa a pasivní odhad gravitace (GM).<br/>
...
def build_english_one_pager(output_path):
    ...
    • <b>Key Technological Innovations:</b> Autonomous DART impact crater detection via INT8 Micro-CNN & PALT laser fusion, lossless CDF 5/3 integer wavelet compression (-82.2% bandwidth), in-situ 3D shape mesh building, and passive gravity parameter (GM) inversion.<br/>
